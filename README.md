...
案件理解、課題仮説、提案、立ち上げ、計画、実行、監視、終結まで、生成AI/DX案件の各フェーズで必要な成果物づくりと判断の足場を支援します。
...
生成AI活用支援、AIエージェント開発、業務のAI Native化など、顧客課題の整理から提案・定着までをつなぐDX/コンサル案件を想定しています。特に「何をAI化すべきか」「どの順番で形にするか」がまだ曖昧な初期状態を、PMが説明可能な計画へ引き上げる場面に向いています。
...
AIはアウトカムを出そうとしますが、手順を守る設計にはなっていません。40プロセスを検査ゲートとしてSkillに埋め込み、前工程の誤りが高くつく場面では必ず人間確認を挟む構造にしています。
...
各工程で止まり、PMが確認して進みます。AIが先にたたき台を作り、人間が確認・承認して次へ進む構造です。
